...
pyinstaller --name "BallonsTranslator" --onedir --windowed --noconfirm --clean --add-data "resources;resources" --add-data "config;config" --add-data "data;data" --hidden-import ballontranslator --hidden-import ballontranslator.modules --hidden-import ballontranslator.ui --hidden-import ballontranslator.utils --collect-submodules ballontranslator run.py
